        ...
        <div class="container mx-auto">
            <div class="grid grid-cols-4 gap-10">
                    ...
                    <div class="footer-col__container">
                        <div class="flex-shrink-0 flex items-center">
                            <a href="{{ route('frontend.home.index') }}">
                                ...
                                <svg viewBox="0 0 316 316" fill="#FFFFFF" xmlns="http://www.w3.org/2000/svg" class="h-16 w-auto text-white">
                ...
                <div class="footer__col footer2">
                    <div class="footer-col__container pl-20">
                ...
                <div class="footer-col footer3">
                    <div class="footer-col__container text-center">
                        <div class="mt-8">
                            <a href="#" class="inline-flex items-center justify-center text-white py-2 px-6 uppercase bg-primary text-white border border-solid border-primary hover:bg-transparent hover:text-primary rounded mb-3 sm:mb-0 mx-auto sm:mx-2 transition-colors duration-300">
