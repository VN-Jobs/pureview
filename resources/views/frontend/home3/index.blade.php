...
@section('content')
    ...
    <section class="home__request">
        <div class="request__form text-white py-20" style="background-color: #242930;
    background-image: url(https://www.vmarkdesign.com.au/wp-content/uploads/2020/02/337.jpg);
            ...
            <div class="latest__blog flex flex-wrap items-center py-8">
                <article class="latest__blog__item w-4/12 md:w-12/12 px-4 first">
                    <div class="entry__image">
                        <a href="#">
                            <img class="post-img" src="/images/blog/1.png" alt="At Mario's Always Fresh Cupcake Ice Cream?">
                        </a>
                    </div>
                ...
                <article class="latest__blog__item w-4/12 md:w-12/12 px-4 first">
                    <div class="entry__image">
                        <a href="#">
                            <img class="post-img" src="/images/blog/2.png" alt="At Mario's Always Fresh Cupcake Ice Cream?">
                        </a>
                    </div>
                    <h4 class="entry__heading text-2xl text-primary mt-4">
                        <a href="#">
                ...
                <article class="latest__blog__item w-4/12 md:w-12/12 px-4 first">
                    <div class="entry__image">
                        <a href="#">
                            <img class="post-img" src="/images/blog/3.png" alt="At Mario's Always Fresh Cupcake Ice Cream?">
                        </a>
                    </div>
                    <h4 class="entry__heading text-2xl text-primary mt-4">
                        <a href="#">
